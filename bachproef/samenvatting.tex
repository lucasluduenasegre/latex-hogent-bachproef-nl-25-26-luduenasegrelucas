...
% Binnen de opleiding \emph{Toegepaste Informatica} op \emph{HOGENT} worden studenten geconfronteerd met infrastructuurlabo's waarbij een gegeven netwerkontwerp manueel moet worden omgezet naar een werkende, geconfigureerde omgeving. Dit proces is tijdrovend en foutgevoelig, en vereist een grondige kennis van zowel de gebruikte diagramnotatie als de onderliggende configuratiebeheerstools. Deze bachelorproef onderzoekt in welke mate dit omzettingsproces geautomatiseerd kan worden.

Op \emph{HOGENT}, binnen de opleiding \emph{Toegepaste Informatica} en meerbepaald het keuzeprofiel ``\emph{IT infrastructure engineer}'', worden er OLODs (opleidingsonderdelen) gegeven die aan de hand van labo's bijdragen aan het leren van serverinfrastructuren beheren. Deze infrastructuren worden geïmplementeerd aan de hand van netwerk- en implementatiediagrammen, ontworpen met UML-modeling software.
...
Deze beperkingen vormen echter potentieel voor toekomstige uitbreidingen, alsook alternatieve IaC-backends en compatibiliteit met IPv6.

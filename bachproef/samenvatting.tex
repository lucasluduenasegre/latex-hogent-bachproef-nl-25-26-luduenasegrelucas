...
De hoofdonderzoeksvraag luidt: Hoe kan men een gegeven netwerk- en implementatiediagram (in tekstuele vorm via bv. PlantUML\footnote{\url{https://plantuml.com/}}) van een infrastructuur met minimale menselijke interventie omzetten tot een overeenkomende, gebruiksklare `\emph{configuration management}'-ondersteunde (bv. met Ansible) omgeving?

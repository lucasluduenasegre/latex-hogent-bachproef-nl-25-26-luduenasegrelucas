...
De labo's 2 en 3 uit \emph{Infrastructure Automation} zijn ook via de ``full mode'' gerecreëerd als Vagrant- en Ansible-ondersteunde omgeving, met uitzondering van de router \texttt{r001} (zie \autoref{subsec:testcase2_beoordeling}).

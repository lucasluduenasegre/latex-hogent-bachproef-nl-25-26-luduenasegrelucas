...
In Hoofdstuk~\ref{ch:testcases} (\nameref{ch:testcases}) wordt de definitie van de verschillende testcases, waaraan de proof-of-concept op wordt getoetst, beschreven. De resultaten van deze testen zullen ook in dit hoofdstuk toegelicht worden

In Hoofdstuk~\ref{ch:conclusie} (\nameref{ch:conclusie}), tenslotte, wordt de conclusie gegeven en een antwoord geformuleerd op de onderzoeksvragen. Daarbij wordt ook een aanzet gegeven voor toekomstig onderzoek binnen dit domein.
...
\subsection{Compilers, parsers, transpilers en hun doel}%
...
Deze infrastructuur zal allicht redelijk simpel gehouden worden met slechts 2-3 servers, aangezien deze bachelorproef vooral over de ontwikkeling van een proof-of-concept gaat. 
% TODO
...
\subsection{Verwachte meerwaarde}%
\label{subsec:verwachte_meerwaarde}
